<template>
    <button class="work-time-stamp-btn focus:ring">
        <slot />
    </button>
</template>
<style scoped>
.work-time-stamp-btn {
    ...
    border-left: 5px solid rgba(255, 0, 0, 0.418);
...
@keyframes slide-bg {
    ...
    100% {
        background: linear-gradient(
            90deg,
            rgba(255, 0, 0, 0.418) 100%,
            white 0%
        );
        color: white;
        border-left: 5px solid rgba(255, 0, 0, 0);
        border-right: 5px solid rgba(255, 0, 0, 0.418);
    }
}
</style>