...
<script lang="ts">
    ...
    import JetActionMessage from '@/views/components/ActionMessage.vue'
    import JetActionSection from '@/views/components/ActionSection.vue'
    import JetButton from '@/views/components/Button.vue'
    import JetConfirmationModal from '@/views/components/ConfirmationModal.vue'
    import JetDangerButton from '@/views/components/DangerButton.vue'
    import JetDialogModal from '@/views/components/DialogModal.vue'
    import JetFormSection from '@/views/components/FormSection.vue'
    import JetInput from '@/views/components/Input.vue'
    import JetCheckbox from '@/views/components/Checkbox.vue'
    import JetInputError from '@/views/components/InputError.vue'
    import JetLabel from '@/views/components/Label.vue'
    import JetSecondaryButton from '@/views/components/SecondaryButton.vue'
    import JetSectionBorder from '@/views/components/SectionBorder.vue'
